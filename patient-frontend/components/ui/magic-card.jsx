...
export function MagicCard(props) {
  ...
  // Hydration-safe "has this mounted on the client yet" flag, without an
  // effect+setState (which would double-render on every mount): subscribes
  // to nothing, so getSnapshot only ever changes between server and client.
